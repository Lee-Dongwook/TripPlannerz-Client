...
export const CreateTravelDrawer = () => {
  const [toggleCreateTravelModal, setToggleCreateTravelModal] =
  ...
  return (
    <>
      <NavbarButton
        name='일정생성'
        style={{ width: '100px' }}
        onClick={handleOpenCreateTravelModal}
      />
      <Drawer
        title='여행 생성'
        style={{ width: '100%', height: '620px', overflowY: 'auto' }}
        placement='top'
        onClose={handleCloseCreateTravelModal}
        visible={toggleCreateTravelModal}
      >
        <CreateTravelForm />
      </Drawer>
    </>
